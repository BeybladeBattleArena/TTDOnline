  /* ================= SOUL SABER EXACT ASSET RUNTIME =================
     ...
     Attack animation requires the separately registered pure-vector Soul Saber artwork.
  */
  ...
  __ttdSoulSaberAttackImage.onerror = () => {
    __ttdSoulSaberAttackLoadError = new Error('Soul Saber pure-vector attack artwork failed to decode.');

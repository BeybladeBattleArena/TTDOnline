(() => {
  ...
  const stage = {
    ...
    zones: [
      {id:'roof1_main',name:'Lower Rooftop',tier:1,x:510,z:20,y:110,w:620,d:310,slots:9,summon:true,enemySpawn:true,material:'tar',facade:190,guardDestructible:'lower_rail'},
    ...
    encounters: [
      {stop:0,cap:4,spawnEvery:3.7,pool:['goblin','goblin_dog']},
      {stop:1,cap:5,spawnEvery:3.3,pool:['goblin','goblin_dog','goblin_thrower']},
      {stop:2,cap:6,spawnEvery:3.0,pool:['goblin','goblin_thrower']},
      {stop:3,cap:7,spawnEvery:2.7,pool:['goblin','goblin_dog','goblin_thrower','goblin_brute']},
      {stop:4,cap:8,spawnEvery:2.4,pool:['goblin','goblin_thrower','goblin_brute']},
      {stop:5,cap:9,spawnEvery:2.1,pool:['goblin','goblin_dog','goblin_thrower','goblin_brute']},
      {stop:6,cap:10,spawnEvery:1.65,pool:['goblin','goblin_dog','goblin_thrower','goblin_brute']},
    ],
  };

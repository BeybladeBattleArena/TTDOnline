(() => {
  ...
  async function boot(){
    ...
    loadPostDocumentScript('/online/jewel-art-inventory-v3.js?v=2','ttdJewelArtInventoryV3Script');
    ...
    loadPostDocumentScript('/online/collection-card-containment-v1.js?v=2','ttdCollectionCardContainmentV1Script');
  }

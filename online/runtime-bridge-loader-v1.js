(() => {
  ...
  const BRIDGES=[
    ...
    // Moving Screen is direct committed source. Stage data loads before the engine and neither
    // authority rewrites, evals, or patches the core game document.
    '/online/moving-screen-neon-rooftops-v1.js?v=1',

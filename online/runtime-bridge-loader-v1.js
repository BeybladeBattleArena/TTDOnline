(() => {
  ...
  const BRIDGES=[
    ...
    // Arcade shell v2 loads last so it can own phone-safe scrolling, dynamic map landing routes,
    // authenticated map starts, and canonical results without patching Moving Screen source text.

(() => {
  ...
  const BRIDGES=[
    ...
    // Moving Screen is a committed Arcade-mode runtime authority. It is loaded as a normal source
    // module; it does not source-replace, eval-patch, or mutate the core game document.

...
for(const marker of ['/online/moving-screen-construction-climb-v1.js?v=2','/online/moving-screen-map-router-v2.js?v=1','/online/moving-screen-construction-presentation-v1.js?v=2'])must(loader.includes(marker),`Construction rework runtime file missing from loader: ${marker}`);

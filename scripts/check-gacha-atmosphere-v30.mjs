...
for(const marker of ["gacha:{url:asset('/assets/audio/gacha.webm')","screen==='gachaScreen'","return'gacha'"])if(!audio.includes(marker))throw new Error(`Gacha audio route missing ${marker}`);
if(!entry.includes("./gacha-atmosphere-v30.js?v=30"))throw new Error('Gacha atmosphere is not loaded.');
console.log('Gacha v30 verified: cache-busted repository-hosted music and seamless dice field.');

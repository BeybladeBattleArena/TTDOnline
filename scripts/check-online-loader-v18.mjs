...
const expectedUrls=[
  ...
  '/online/moving-screen-neon-rooftops-v2.js?v=4','/online/moving-screen-construction-climb-v1.js?v=2','/online/moving-screen-engine-v5.js?v=1','/online/moving-screen-map-router-v2.js?v=1','/online/moving-screen-ui-v1.js?v=1','/online/moving-screen-die-input-v1.js?v=1','/online/moving-screen-topology-ui-v1.js?v=1','/online/moving-screen-construction-presentation-v1.js?v=2','/online/moving-screen-battle-hud-v1.js?v=1','/online/arcade-mode-shell-v2.js?v=4','/online/moving-screen-mobile-frame-v2.js?v=1','/online/singleplayer-run-controls-v1.js?v=1',
];
...
must(runtime.indexOf('/online/moving-screen-die-input-v1.js?v=1')<runtime.indexOf('/online/moving-screen-topology-ui-v1.js?v=1'),'Die gestures must capture a Die-origin gesture before route-swipe topology input.');
must(runtime.indexOf('/online/moving-screen-mobile-frame-v2.js?v=1')<runtime.indexOf('/online/singleplayer-run-controls-v1.js?v=1'),'Shared single-player run controls must load after Moving Screen frame presentation.');

...
const expectedUrls=[
  ...
  '/online/moving-screen-neon-rooftops-v2.js?v=4','/online/moving-screen-construction-climb-v1.js?v=2','/online/moving-screen-engine-v4.js?v=8','/online/moving-screen-map-router-v1.js?v=2','/online/moving-screen-ui-v1.js?v=1','/online/moving-screen-topology-ui-v1.js?v=1','/online/moving-screen-construction-presentation-v1.js?v=2','/online/arcade-mode-shell-v2.js?v=4','/online/moving-screen-mobile-frame-v1.js?v=1',
];
...
for(const stale of ['/online/moving-screen-engine-v4.js?v=4','/online/moving-screen-engine-v4.js?v=5','/online/moving-screen-engine-v4.js?v=6','/online/moving-screen-engine-v4.js?v=7','/online/moving-screen-construction-climb-v1.js?v=1','/online/moving-screen-map-router-v1.js?v=1','/online/moving-screen-construction-presentation-v1.js?v=1'])must(!runtime.includes(stale),`Moving Screen combat/safety release must not reuse stale cache key: ${stale}`);
...
console.log('Loader recovery contract verified: Moving Screen loads Neon + Demolition-style Construction -> canonical-combat vertical-safety engine -> map router -> route/topology UI -> Construction presentation -> Arcade shell -> mobile frame without runtime source rewriting.');
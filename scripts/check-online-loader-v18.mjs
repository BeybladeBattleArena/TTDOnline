...
must(runtime.indexOf('/online/moving-screen-mobile-frame-v2.js?v=2')<runtime.indexOf('/online/singleplayer-run-controls-v1.js?v=3'),'Shared single-player run controls must load after Moving Screen frame presentation.');

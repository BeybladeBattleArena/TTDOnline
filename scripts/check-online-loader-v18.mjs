...
const expectedUrls=[
  ...
  '/online/moving-screen-neon-rooftops-v2.js?v=2','/online/moving-screen-engine-v2.js?v=2',
];
...
must(!runtime.includes('/online/moving-screen-engine-v1.js?v=1'),'retired Moving Screen v1 engine must not be runtime-loaded beside v2.');
for(const marker of [
...
console.log('Loader v19 recovery contract verified: native bridge readiness remains ordered and source-direct; item/world authorities and Moving Screen v2 stage+engine load explicitly; battle hooks remain stable; and game-loader.js still performs no runtime source reconstruction.');

...
const expectedUrls=[
  ...
  '/online/moving-screen-neon-rooftops-v2.js?v=3','/online/moving-screen-engine-v4.js?v=6','/online/moving-screen-ui-v1.js?v=1',
];
...
must(!runtime.includes('/online/moving-screen-neon-rooftops-v2.js?v=2'),'Moving Screen timing polish must not reuse the stale stage v2 query key.');
...
console.log('Loader recovery contract verified: bridge readiness stays ordered/source-direct and Moving Screen loads the cache-busted stage, rebuilt v4 engine, then direct UI polish authority.');

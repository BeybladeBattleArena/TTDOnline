...
for(const marker of ['window.__TTD_MOVING_SCREEN_MAP_ROUTER_V2=true',"const LOADING_ID='ttdMsLoadingV2'",'const LOADING_MIN_MS=720',"const LOADING_ASSET='/assets/ui/loading-moving-screen.png'",'img.src=asset(LOADING_ASSET)','base.start()','LOADING_DECODE_MAX_MS=2500','Promise.all([sleep(LOADING_MIN_MS)','startPresentationSync()','announceActive(true)'])must(router.includes(marker),`Moving Screen loading/router contract missing: ${marker}`);
...
const urls={
  stage:"'/online/moving-screen-neon-rooftops-v2.js?v=4'",construction:"'/online/moving-screen-construction-climb-v1.js?v=2'",engine:"'/online/moving-screen-engine-v5.js?v=1'",router:"'/online/moving-screen-map-router-v2.js?v=2'",ui:"'/online/moving-screen-ui-v1.js?v=1'",dieInput:"'/online/moving-screen-die-input-v1.js?v=2'",topology:"'/online/moving-screen-topology-ui-v1.js?v=1'",presentation:"'/online/moving-screen-construction-presentation-v1.js?v=2'",battleHud:"'/online/moving-screen-battle-hud-v1.js?v=2'",frame:"'/online/moving-screen-mobile-frame-v2.js?v=2'",runControls:"'/online/singleplayer-run-controls-v1.js?v=2'"
};

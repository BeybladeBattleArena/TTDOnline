...
const urls={
  stage:"'/online/moving-screen-neon-rooftops-v2.js?v=4'",construction:"'/online/moving-screen-construction-climb-v1.js?v=2'",engine:"'/online/moving-screen-engine-v5.js?v=2'",router:"'/online/moving-screen-map-router-v2.js?v=3'",ui:"'/online/moving-screen-ui-v1.js?v=1'",dieInput:"'/online/moving-screen-die-input-v1.js?v=2'",topology:"'/online/moving-screen-topology-ui-v1.js?v=1'",presentation:"'/online/moving-screen-construction-presentation-v1.js?v=2'",battleHud:"'/online/moving-screen-battle-hud-v1.js?v=2'",frame:"'/online/moving-screen-mobile-frame-v2.js?v=2'",runControls:"'/online/singleplayer-run-controls-v1.js?v=3'"
};

...
console.log('Battle loop v20 verified: strict-mode bridge isolation cannot hide Magma/Soul/Slither hooks from the first animation frame, while unrelated bridges remain isolated.');

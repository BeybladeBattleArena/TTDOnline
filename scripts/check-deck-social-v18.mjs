...
requireMarkers(loader,['const isolatedSources=sources.slice(3).map','TTD_BATTLE_HOOK_SCOPE_V20','failed without blocking later bridges.','bridge-runtime-error'],'bridge isolation');
